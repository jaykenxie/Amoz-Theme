...
<head>
  ...
  input:focus,
  textarea:focus {
    border: 1px solid <?php $this->options->themeColor() ?>;
  }
  ...
  .page-navigator .current a {
    background: <?php $this->options->themeColor() ?>;
  }
  ...
  .comment-form-info input:focus {
    border-bottom-color: <?php $this->options->themeColor() ?>;
  }
    ...
    <div class="container head-box">
      ...
      <div class="site-search container-wrap right-wrap">
        ...
        <div class="user-info">
          ...
          <a class="user-info_username" href="javascript:void(0)"><span><i
                class="iconfont icon-wo"></i><?php $this->user->screenName(); ?></span></a>
